...
const categoryFallbackProducts = {
  men: [
    // ── T-Shirts (All Men Models / Verified T-Shirts ONLY) ──
    ...
    { _id: 'men-tshirt-9', name: 'Minimalist Typography Print Tee', price: 1199, originalPrice: 1599, category: { name: 'T-Shirts' }, gender: 'Men', image: '/products/men_tshirt_typography.jpg', isNewArrival: false },
    { _id: 'men-tshirt-10', name: 'French Terry Mockneck Tee', price: 1799, originalPrice: 2299, category: { name: 'T-Shirts' }, gender: 'Men', image: '/products/men_tshirt_mockneck.jpg', isNewArrival: false },
    ...
    { _id: 'men-tshirt-13', name: 'Distressed Washed Vintage Tee', price: 1299, originalPrice: 1699, category: { name: 'T-Shirts' }, gender: 'Men', image: '/products/men_tshirt_vintage.jpg', isNewArrival: false },
    { _id: 'men-tshirt-14', name: 'Half-Zip Sports Performance Tee', price: 1699, originalPrice: 2199, category: { name: 'T-Shirts' }, gender: 'Men', image: '/products/men_sports_tee.jpg', isNewArrival: true },
    ...
    // ── Shirts (All Men Models & Collared/Button-down Shirts ONLY) ──
    ...
    { _id: 'men-shirt-7', name: 'Crisp Cotton Poplin Formal Shirt', price: 1899, originalPrice: 2499, category: { name: 'Shirts' }, gender: 'Men', image: '/products/men_cuban_shirt.jpg', isNewArrival: true },
    ...
    { _id: 'men-shirt-13', name: 'Corduroy Patchwork Work Shirt', price: 2499, originalPrice: 3199, category: { name: 'Shirts' }, gender: 'Men', image: '/products/men_flannel_shirt_1788285952163.jpg', isNewArrival: false },
    ...
    { _id: 'men-shirt-16', name: 'Garment-Dyed Pigment Linen Shirt', price: 2299, originalPrice: 2999, category: { name: 'Shirts' }, gender: 'Men', image: '/products/men_resort_shirt_1788285977869.jpg', isNewArrival: false },

    // ── Jeans (All Men Models & Denim ONLY) ──
    ...
    // ── Jackets (All Men Models & Outerwear ONLY) ──
    ...
    { _id: 'men-jacket-12', name: 'Shearling-Collar Suede Aviator Bomber', price: 6499, originalPrice: 7999, category: { name: 'Jackets' }, gender: 'Men', image: '/products/men_corduroy_trucker_1788285865339.jpg', isNewArrival: true },
    ...
    { _id: 'men-jacket-15', name: 'Technical Shell Windbreaker Jacket', price: 3899, originalPrice: 4899, category: { name: 'Jackets' }, gender: 'Men', image: '/products/men_utility_jacket_1788285839341.jpg', isNewArrival: true },
    { _id: 'men-jacket-16', name: 'Sartorial Italian Overcoat', price: 5999, originalPrice: 7499, category: { name: 'Jackets' }, gender: 'Men', image: '/products/men_wool_overcoat_1788285677205.jpg', isNewArrival: false },

    // ── Trousers (All Men Models & Trousers ONLY) ──
  ...
  women: [
    // ── Dresses (All Women Models & Authentic Dresses/Gowns) ──
    ...
    { _id: 'women-dress-7', name: 'Sculptural Plissé Pleated Column Gown', price: 5499, originalPrice: 6999, category: { name: 'Dresses' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1566174053879-31528523f8ae?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
    ...
    { _id: 'women-dress-11', name: 'Backless Halter Silk Charmeuse Gown', price: 5299, originalPrice: 6699, category: { name: 'Dresses' }, gender: 'Women', image: '/products/emerald_velvet_gown.jpg', isNewArrival: false },
    { _id: 'women-dress-12', name: 'Minimalist High-Neck Crepe Maxi Dress', price: 4199, originalPrice: 5299, category: { name: 'Dresses' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
    { _id: 'women-dress-13', name: 'Bohemian Paisley Wrap Maxi Dress', price: 3799, originalPrice: 4799, category: { name: 'Dresses' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1496747611176-843222e1e57c?auto=format&fit=crop&q=80&w=800', isNewArrival: false },
    ...
    { _id: 'women-dress-15', name: 'Lace-Trim Puff-Sleeve Taffeta Dress', price: 4899, originalPrice: 6199, category: { name: 'Dresses' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1572804013309-59a88b7e92f1?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
    { _id: 'women-dress-16', name: 'Dip-Dye Ombré Chiffon Midi Dress', price: 3499, originalPrice: 4399, category: { name: 'Dresses' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&q=80&w=800', isNewArrival: false },

    // ── Blazers (All Women Models & Tailored Blazers ONLY) ──
    ...
    { _id: 'women-blazer-4', name: 'Organic French Linen Relaxed Blazer', price: 4699, originalPrice: 5899, category: { name: 'Blazers' }, gender: 'Women', image: '/products/linen_relaxed_blazer.jpg', isNewArrival: false },
    ...
    { _id: 'women-blazer-6', name: 'Contemporary Streetwear Houndstooth Blazer', price: 4499, originalPrice: 5699, category: { name: 'Blazers' }, gender: 'Women', image: '/products/houndstooth_blazer.jpg', isNewArrival: true },
    { _id: 'women-blazer-7', name: 'Midnight Silk-Satin Tuxedo Evening Blazer', price: 6299, originalPrice: 7899, category: { name: 'Blazers' }, gender: 'Women', image: '/products/tuxedo_evening_blazer.jpg', isNewArrival: true },
    { _id: 'women-blazer-8', name: 'Cropped Double-Breasted Bouclé Tweed Jacket', price: 4799, originalPrice: 5999, category: { name: 'Blazers' }, gender: 'Women', image: '/products/boucle_tweed_blazer.jpg', isNewArrival: false },
    { _id: 'women-blazer-9', name: 'Hourglass Sculpted Waist Crepe Blazer', price: 5399, originalPrice: 6799, category: { name: 'Blazers' }, gender: 'Women', image: '/products/hourglass_crepe_blazer.jpg', isNewArrival: true },
    { _id: 'women-blazer-10', name: 'Burgundy Velvet Peak-Lapel Cocktail Blazer', price: 5799, originalPrice: 7199, category: { name: 'Blazers' }, gender: 'Women', image: '/products/burgundy_velvet_blazer.jpg', isNewArrival: false },
    { _id: 'women-blazer-11', name: 'Heritage Glen Plaid Wool Boyfriend Blazer', price: 4999, originalPrice: 6299, category: { name: 'Blazers' }, gender: 'Women', image: '/products/glen_plaid_blazer.jpg', isNewArrival: false },
    { _id: 'women-blazer-12', name: 'Belted Wool Kimono Drape Blazer', price: 5199, originalPrice: 6499, category: { name: 'Blazers' }, gender: 'Women', image: '/products/kimono_drape_blazer.jpg', isNewArrival: true },
    { _id: 'women-blazer-13', name: 'Caramel Oversized Cocoon Coat Blazer', price: 5599, originalPrice: 6999, category: { name: 'Blazers' }, gender: 'Women', image: '/products/caramel_cocoon_blazer.jpg', isNewArrival: false },
    { _id: 'women-blazer-14', name: 'Neon-Trim Monochrome Power Blazer', price: 4299, originalPrice: 5499, category: { name: 'Blazers' }, gender: 'Women', image: '/products/oversized-boxy-blazer.jpg', isNewArrival: true },
    { _id: 'women-blazer-15', name: 'Collarless Minimalist Knit Blazer', price: 4599, originalPrice: 5799, category: { name: 'Blazers' }, gender: 'Women', image: '/products/tailored-double-breasted-blazer.jpg', isNewArrival: false },
    { _id: 'women-blazer-16', name: 'Bold Stripe Colour-Block Blazer', price: 4799, originalPrice: 5999, category: { name: 'Blazers' }, gender: 'Women', image: '/products/pinstripe-tailored-blazer.jpg', isNewArrival: true },

    // ── Trousers (All Women Models & Trousers ONLY) ──
    ...
    { _id: 'women-trouser-6', name: 'Flared Sartorial Gabardine Trousers', price: 3599, originalPrice: 4499, category: { name: 'Trousers' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
    ...
    { _id: 'women-trouser-8', name: 'High-Waist Silk-Wool Palazzo Pants', price: 3999, originalPrice: 4999, category: { name: 'Trousers' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1506629082955-511b1aa562c8?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
    { _id: 'women-trouser-9', name: 'Double-Pleated Sailor Trousers with Horn Buttons', price: 3399, originalPrice: 4299, category: { name: 'Trousers' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?auto=format&fit=crop&q=80&w=800', isNewArrival: false },
    ...
    { _id: 'women-trouser-11', name: 'Split-Hem Tailored Slim Pants', price: 3199, originalPrice: 3999, category: { name: 'Trousers' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1517445312882-bc9910d016b7?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
    { _id: 'women-trouser-12', name: 'Fluid Satin Drawstring Lounge Slacks', price: 2999, originalPrice: 3799, category: { name: 'Trousers' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1551854838-212c50b4c184?auto=format&fit=crop&q=80&w=800', isNewArrival: false },
    { _id: 'women-trouser-13', name: 'Asymmetric-Hem Deconstructed Trousers', price: 3299, originalPrice: 4199, category: { name: 'Trousers' }, gender: 'Women', image: '/products/pleated-wool-trousers.jpg', isNewArrival: true },
    { _id: 'women-trouser-14', name: 'Velvet Straight-Leg Evening Trousers', price: 3799, originalPrice: 4799, category: { name: 'Trousers' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1551854838-212c50b4c184?auto=format&fit=crop&q=80&w=800', isNewArrival: false },
    { _id: 'women-trouser-15', name: 'Elasticated-Waist Linen Beach Trousers', price: 2499, originalPrice: 3199, category: { name: 'Trousers' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1506629082955-511b1aa562c8?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
    { _id: 'women-trouser-16', name: 'Power-Stretch High-Waist Ponte Trousers', price: 2899, originalPrice: 3699, category: { name: 'Trousers' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1594633312681-425c7b97ccd1?auto=format&fit=crop&q=80&w=800', isNewArrival: false },

    // ── Jeans (All Women Models & Authentic Denim ONLY) ──
    ...
    { _id: 'women-jean-7', name: 'Sculpt Skinny High-Rise Stretch Denim', price: 2899, originalPrice: 3699, category: { name: 'Jeans' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&q=80&w=800', isNewArrival: false },
    { _id: 'women-jean-8', name: 'Natural Ecru Raw-Hem Cropped Wide Jeans', price: 2999, originalPrice: 3799, category: { name: 'Jeans' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1584370848010-d7fe6bc767ec?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
    { _id: 'women-jean-9', name: 'Relaxed Workwear Carpenter Jeans with Loop', price: 2899, originalPrice: 3599, category: { name: 'Jeans' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1584370848010-d7fe6bc767ec?auto=format&fit=crop&q=80&w=800', isNewArrival: false },
    { _id: 'women-jean-10', name: 'Low-Rise Baggy Utility Cargo Jeans', price: 3399, originalPrice: 4299, category: { name: 'Jeans' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1582418702059-97ebafb35d09?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
    { _id: 'women-jean-11', name: 'Barrel Curve Silhouette Denim', price: 3199, originalPrice: 3999, category: { name: 'Jeans' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1576995853123-5a10305d93c0?auto=format&fit=crop&q=80&w=800', isNewArrival: false },
    { _id: 'women-jean-12', name: 'Split Two-Tone Contrast Inseam Denim', price: 3499, originalPrice: 4399, category: { name: 'Jeans' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1565084888279-aca607ecce0c?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
    { _id: 'women-jean-13', name: 'Patchwork Contrast Panel Denim', price: 3299, originalPrice: 4199, category: { name: 'Jeans' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1582418702059-97ebafb35d09?auto=format&fit=crop&q=80&w=800', isNewArrival: false },
    { _id: 'women-jean-14', name: 'Mid-Rise Cropped Frayed Ankle Jeans', price: 2699, originalPrice: 3399, category: { name: 'Jeans' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
    { _id: 'women-jean-15', name: 'Powder Blue Cloud-Wash Straight Jeans', price: 2999, originalPrice: 3799, category: { name: 'Jeans' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1584370848010-d7fe6bc767ec?auto=format&fit=crop&q=80&w=800', isNewArrival: false },
    { _id: 'women-jean-16', name: 'Exposed Button-Fly Raw-Selvedge Denim', price: 3599, originalPrice: 4599, category: { name: 'Jeans' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1576995853123-5a10305d93c0?auto=format&fit=crop&q=80&w=800', isNewArrival: true },

    // ── Shoes (All Women's Footwear ONLY) ──
    ...
    { _id: 'women-shoe-10', name: 'Suede Block-Heel Chelsea Ankle Boots', price: 4599, originalPrice: 5799, category: { name: 'Shoes' }, gender: 'Women', image: '/products/pointed-leather-ankle-boots.jpg', isNewArrival: true },
    { _id: 'women-shoe-11', name: 'Square-Toe Italian Lambskin Ballet Flats', price: 2999, originalPrice: 3899, category: { name: 'Shoes' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1562273138-f46be4ebdf33?auto=format&fit=crop&q=80&w=800', isNewArrival: false },
    { _id: 'women-shoe-12', name: 'Knee-High Slouchy Suede Western Boots', price: 5499, originalPrice: 6999, category: { name: 'Shoes' }, gender: 'Women', image: '/products/pointed-leather-ankle-boots.jpg', isNewArrival: true },
    { _id: 'women-shoe-13', name: 'Crystal-Embellished T-Strap Heeled Sandals', price: 4799, originalPrice: 5999, category: { name: 'Shoes' }, gender: 'Women', image: '/products/gold-strappy-heels.jpg', isNewArrival: false },
    { _id: 'women-shoe-14', name: 'Sporty Dad Chunky Retro Sneakers', price: 3199, originalPrice: 3999, category: { name: 'Shoes' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
    { _id: 'women-shoe-15', name: 'Woven Leather Slingback Heels', price: 3899, originalPrice: 4899, category: { name: 'Shoes' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?auto=format&fit=crop&q=80&w=800', isNewArrival: false },
    { _id: 'women-shoe-16', name: 'Clear-Strap Perspex Toe-Loop Flatform Mules', price: 2799, originalPrice: 3499, category: { name: 'Shoes' }, gender: 'Women', image: '/products/chunky-platform-loafers.jpg', isNewArrival: true },
  ],
};
...
console.log('Successfully updated CategoryPage.jsx with accurate images!');
