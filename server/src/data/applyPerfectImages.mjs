...
const categoryFallbackProducts = {
  men: [
    // ── T-Shirts (All Men Models & Authentic T-Shirts) ──
    ...
    // ── Shirts (All Men Models & Authentic Collared/Button-down Shirts) ──
    ...
    // ── Jeans (All Men Models & Authentic Denim) ──
    ...
    // ── Jackets (All Men Models & Outerwear/Jackets ONLY) ──
    ...
    // ── Trousers (All Men Models & Trousers/Pants ONLY) ──
  ...
  women: [
    ...
    // ── Blazers (All Women Models & Authentic Blazers ONLY) ──
    ...
    { _id: 'women-blazer-6', name: 'Contemporary Streetwear Houndstooth Blazer', price: 4499, originalPrice: 5699, category: { name: 'Blazers' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
    ...
    { _id: 'women-blazer-9', name: 'Hourglass Sculpted Waist Crepe Blazer', price: 5399, originalPrice: 6799, category: { name: 'Blazers' }, gender: 'Women', image: '/products/tailored-double-breasted-blazer.jpg', isNewArrival: true },
    { _id: 'women-blazer-10', name: 'Burgundy Velvet Peak-Lapel Cocktail Blazer', price: 5799, originalPrice: 7199, category: { name: 'Blazers' }, gender: 'Women', image: '/products/leather-tailored-blazer.jpg', isNewArrival: false },
    { _id: 'women-blazer-11', name: 'Heritage Glen Plaid Wool Boyfriend Blazer', price: 4999, originalPrice: 6299, category: { name: 'Blazers' }, gender: 'Women', image: '/products/oversized-boxy-blazer.jpg', isNewArrival: false },
    { _id: 'women-blazer-12', name: 'Belted Wool Kimono Drape Blazer', price: 5199, originalPrice: 6499, category: { name: 'Blazers' }, gender: 'Women', image: '/products/pinstripe-tailored-blazer.jpg', isNewArrival: true },
    { _id: 'women-blazer-13', name: 'Caramel Oversized Cocoon Coat Blazer', price: 5599, originalPrice: 6999, category: { name: 'Blazers' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1591369822096-ffd140ec948f?auto=format&fit=crop&q=80&w=800', isNewArrival: false },
    { _id: 'women-blazer-14', name: 'Neon-Trim Monochrome Power Blazer', price: 4299, originalPrice: 5499, category: { name: 'Blazers' }, gender: 'Women', image: '/products/tailored-double-breasted-blazer.jpg', isNewArrival: true },
    { _id: 'women-blazer-15', name: 'Collarless Minimalist Knit Blazer', price: 4599, originalPrice: 5799, category: { name: 'Blazers' }, gender: 'Women', image: '/products/oversized-boxy-blazer.jpg', isNewArrival: false },
    ...
    // ── Trousers (All Women Models & Trousers/Pants ONLY) ──
    ...
    { _id: 'women-trouser-14', name: 'Velvet Straight-Leg Evening Trousers', price: 3799, originalPrice: 4799, category: { name: 'Trousers' }, gender: 'Women', image: '/products/cargo-trousers.jpg', isNewArrival: false },
    ...
    { _id: 'women-shoe-15', name: 'Woven Leather Slingback Heels', price: 3899, originalPrice: 4899, category: { name: 'Shoes' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1535043934128-cf0b28d52f95?auto=format&fit=crop&q=80&w=800', isNewArrival: false },
    { _id: 'women-shoe-16', name: 'Clear-Strap Perspex Toe-Loop Flatform Mules', price: 2799, originalPrice: 3499, category: { name: 'Shoes' }, gender: 'Women', image: 'https://images.unsplash.com/photo-1562273138-f46be4ebdf33?auto=format&fit=crop&q=80&w=800', isNewArrival: true },
  ],
};
